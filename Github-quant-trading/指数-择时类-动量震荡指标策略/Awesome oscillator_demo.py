...
def plot(new):
    ...
    new['Close'].plot()
    ax.plot(new.loc[new['awesome signals'] == 1].index, new['Close'][new['awesome signals'] == 1], label='AWESOME LONG',
            lw=0, marker='^', c='g')
    ax.plot(new.loc[new['awesome signals'] == -1].index, new['Close'][new['awesome signals'] == -1],
            label='AWESOME SHORT', lw=0, marker='v', c='r')
    ...
    new['Close'].plot()
    bx.plot(new.loc[new['macd signals'] == 1].index, new['Close'][new['macd signals'] == 1], label='MACD LONG', lw=0,
            marker='^', c='g')
    bx.plot(new.loc[new['macd signals'] == -1].index, new['Close'][new['macd signals'] == -1], label='MACD SHORT', lw=0,
            marker='v', c='r')
    ...
    plt.xlabel('')
    plt.xticks([])
    plt.savefig(r'result\Oscillator.jpg')
    plt.show()
    ...
    plt.savefig(r'result\Awesome_moving_average.jpg')
    ...
    plt.legend(loc='best')
    plt.grid(True)
    plt.savefig(r'result\MACD_moving_average.jpg')
    plt.show()
...
def profit(portfolio):
    ...
    plt.savefig(r'result\Awesome_versus_MACD.jpg')
    plt.show()
