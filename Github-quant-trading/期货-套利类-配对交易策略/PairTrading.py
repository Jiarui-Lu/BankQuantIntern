...
def plot(data, ticker1, ticker2):
    ...
    plt.xlabel('Date')
    plt.grid(True)
    plt.savefig(r'result\Pait_trading_strategy.jpg')
    plt.show()
...
def portfolio(data):
    ...
    plt.savefig(r'result\total_assets.jpg')
    plt.show()
...
def main():
    ...
    asset1 = pd.read_excel(r'data\DJI.xls', index_col=0)
    asset2 = pd.read_excel(r'data\NVDA.xls', index_col=0)
    # create signals
